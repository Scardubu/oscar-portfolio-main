  ...
  return (
    ...
    >
      <div className="container">
        ...
        >
          <m.span variants={header} className="label">
            <span
        ...
        <m.div variants={container} initial="hidden" animate={inView ? 'visible' : 'hidden'}>
          ...
          >
            ...
            <p className="font-display text-text-secondary mt-6 max-w-[72ch] text-base leading-8">
            ...
            <p className="font-display text-text-secondary mt-6 max-w-[72ch] border-l-2 border-[rgba(245,158,11,0.35)] pl-3 text-sm italic">
