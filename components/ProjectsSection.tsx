      ...
      <div className="container">
        ...
        <motion.div variants={container} initial="hidden" animate={inView ? 'visible' : 'hidden'}>
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-6 border-t border-[color:var(--color-border)] pt-7 text-xs tracking-[0.16em] uppercase">
              {featured.demoUrl ? (
                <a
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            {grid.map((project, index) => (
              ...
              >
                ...
                <p
                  className="mt-4 text-base leading-8 text-[color:var(--color-text-muted)]"
                  style={{ fontFamily: 'var(--font-display)' }}
                >
                  {project.description}
                </p>
                ...
                <div className="mt-7 flex flex-wrap gap-4 border-t border-[color:var(--color-border)] pt-6 text-xs tracking-[0.16em] uppercase">
                  {project.demoUrl ? (
                    <a
