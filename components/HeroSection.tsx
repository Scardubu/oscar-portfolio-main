    ...
    >
      ...
      <div className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-7xl items-center gap-12 lg:grid-cols-[1.04fr_0.96fr]">
        ...
        >
          ...
          >
            {HERO.h1}
            <span className="mt-4 block text-2xl leading-tight font-medium tracking-[-0.02em] text-white/70 sm:mt-3 sm:text-3xl">
              {HERO.subHeadline}
            </span>
          </h1>

          <p className="mt-6 max-w-2xl text-lg leading-8 text-pretty text-white/72">{HERO.body}</p>
