        ...
        <m.div variants={child} className="mb-8 sm:mb-12">
          <SectionIntro
            ...
            {/* V1.3: Consequence-first rewrite. Opens with what both audiences get
                ('how the systems are actually built'), then signals the technical content
                (architecture, ML). Em dash rhythm preserved — consistent voice marker.
                'From Lagos to the world.' kept as the geographic-conviction close.
                Non-technical reader: 'how the systems are actually built' = accessible entry.
