...
export const PROJECTS: readonly Project[] = [
  ...
  },
  {
    ...
    status: 'live',
    featured: true,
    tagline: 'Self-improving AI agent fleet — triadic LLM routing under 8GB RAM, autonomous strategy evolution, checkpoint-based fault recovery, live ops dashboard.',
    description:
