...
export async function GET() {
  return new ImageResponse(
    ...
    >
      ...
      >
        Staff Backend and Platform Engineer
      </div>
      <div
        style={{
          fontSize: 68,
      ...
      >
        Reliability-first AI, fintech, and platform systems built for audit season,
        compliance pressure, and real incidents.
      </div>
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
        {['FastAPI', 'Java', 'Redis', 'Postgres', 'Next.js', 'ML Infra'].map((tag) => (
          <div
            key={tag}
            style={{
              fontSize: 13,
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.38)' }}>
            Available · Staff roles · Co-founder · Consulting
          </span>
        </div>
      </div>
    </div>,
